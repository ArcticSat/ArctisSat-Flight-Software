...
class PowerSupply:
    def __init__(self, COMport, baudrate=9600, slave=1, voltage_limit=30.0, current_limit=10.0):
        self.voltage_limit = voltage_limit  # Voltage limit in volts
        self.current_limit = current_limit  # Current limit in amps
        self.slave = slave

        self.client = ModbusClient(port=COMport, baudrate=9600, timeout=1, stopbits=1, bytesize=8, parity='N')
