...
/***************************************************************************//**
  The function custom_MSS_UART_polled_tx_string() is a modified version of
  MSS_UART_polled_tx_string(). Instead of transmitting a NULL ('\0')
  terminated string, it transfers a set number of bytes by taking the transmit
  buffer size as an input.
*/
