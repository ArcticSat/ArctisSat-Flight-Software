...
//			break;
//		}
//		case POWER_SET_POW_MODE_CMD:{ // Read solar current command
//			cmd.id = POW_TXID;
//			cmd.dlc = 2;
...
//			break;
//		}
//		case POWER_AIT_SET_BATTERY_SOC_CMD:{ // Read solar current command
//			cmd.id = POW_TXID;
//			cmd.dlc = 5;
...
//			break;
//		}
//		case POWER_AIT_SET_ECLIPSE:{ // Read solar current command
//			cmd.id = POW_TXID;
//			cmd.dlc = 2;
//			cmd.data[0] = POWER_AIT_SET_ECLIPSE;
//			cmd.data[1] = cmd_pkt->data[0];
//			CAN_transmit_message(&cmd);
//			break;
//		}
